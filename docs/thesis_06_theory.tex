...
According to the CAP (\fb{Consistency} \fb{Availability} \fb{Partitioning}) showing that, for distributed systems, either consistency or availability can be guaranteed, not both.
