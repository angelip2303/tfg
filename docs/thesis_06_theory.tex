...
\begin{figure}[ht]
    \centering
    \includestandalone{diagrams/6-6_pregelTrace}
...
\begin{figure}[ht]
    \centering
    \includestandalone{diagrams/6-7_stateDiagram}
...
\begin{figure}[H]
    \centering
    \includestandalone[width=0.66\textwidth]{diagrams/6-8_pregelArchitecture}
