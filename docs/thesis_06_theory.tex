...
Lastly, a statement is a piece of data about an item and is recorded on the page of the item itself. Putting it all together, the way Wikibase manages information is as follows: through a statement, we add information to a certain item using some property and its value. This can be seen in figure \ref{fig:wikibaseGraph}.
...
\begin{figure}[ht]
    ...
    \label{fig:wikibaseGraph}
\end{figure}
\footnotetext{\url{https://www.mediawiki.org/wiki/Wikibase/DataModel\#Statements}}

The different components that appear in figure \ref{fig:wikibaseGraph} are as follows:
