...
\begin{figure}[ht]
    \centering
    \includestandalone[width=0.5\textwidth]{figures/fig_02_architectureWikibase}
...
\href{https://www.wikidata.org/wiki/Q11679}{The Hunger Games (Q11679)} item in Wikidata has the attribute \href{https://www.wikidata.org/wiki/Property:P136}{genre (P136)} with the value \href{https://www.wikidata.org/wiki/Q15062348}{dystopian fiction (Q15062348)}, simulating the example above. The outcome is that the final statement will look like Figure \ref{fig:thg}. There is no need for coding because this procedure is carried out through a front-end. This allows any user, regardless of technical proficiency, to add data about any entity to Wikidata. You'll note that the statement can be modified by adding more details, amended, or even deleted.

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{../img/wikidata_statement.png}
...
\begin{figure}[ht]
    \centering
    \includestandalone[width=0.8\textwidth]{figures/fig_04_RDF}
...
\begin{lstlisting}[caption={ShExC syntax example declaring that nodes of the shape Person must fulfill some schema},captionpos=b,style=Turtle]
:Person {
    :birthPlace @:Place ;
    :birthDate @:Date ;
...
Following the previous example, another possibility is to visualize ShEx schemas using UML-like class diagrams. This way, the following representation arises:

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{fig_05_ShEx.eps}
...
\begin{figure}[ht]
    \centering
    \includestandalone[width=0.6\textwidth]{figures/fig_06_WShEx}
...
\begin{lstlisting}[caption={ShExC syntax example declaring that nodes of the shape Person must fulfill some schema},style=Turtle]
:Human {
    birthPlace @ < Place > ;
    birthDate @ < Time > ;
    employer @ < Organization > *
...
\begin{table}[h]
    \vspace{-2mm}
    \centering
    \input{figures/tab_03_wikibaseSubgraph}
\end{table}
...
\begin{figure}[ht]
    \centering
    \includestandalone{figures/fig_07_pregelTrace}
...
\begin{figure}[ht]
    \centering
    \includestandalone{figures/fig_08_stateDiagram}
...
\begin{figure}[ht]
    \centering
    \includestandalone[width=0.75\textwidth]{figures/fig_09_pregelArchitecture}
