...
\begin{table}[ht]
    ...
    \end{tabular}
    \caption{Supported features of the \texttt{Shape} \texttt{Expression} model implementation in \texttt{pschema-rs}}
\end{table}
...
\begin{example}
    ...
    \end{minipage}
    \begin{minipage}{0.45\textwidth}
        \includestandalone[width=\textwidth]{diagrams/11-2_tree}
    \end{minipage}
\end{example}
