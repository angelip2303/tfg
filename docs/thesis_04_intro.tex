...
\begin{figure}[ht]
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=.7\linewidth]{img/Konigsberg_bridges.png}
    ...
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=.7\linewidth]{img/Konigsberg_abstract.png}
    ...
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=.7\linewidth]{img/Konigsberg_graph.png}
