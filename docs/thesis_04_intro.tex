...
\textit{Learn new technologies and Big data techniques.} As this is an academic project and one of the main objectives of researching is finding new solutions to a certain problem. Learning and exploring new possibilities is -- indeed -- one of this project's goals.
