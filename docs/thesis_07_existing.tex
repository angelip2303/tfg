...
\begin{itemize}
    ...
    \item \texttt{sendMsg}: the user-defined function that is applied to all the out edges of vertices receiving a message in the current iteration. That is, a function that computes the messages to be sent to the neighbors of a node for the next iteration.
