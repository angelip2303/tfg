...
% Statuses
\newcommand{\Ok}{\ensuremath{\c{Ok}}}
\newcommand{\Failed}{\ensuremath{\c{Failed}}}
\newcommand{\WaitingFor}[3]{\ensuremath{\c{WaitingFor}(\c{#1},\c{#2},\c{#3})}}
\newcommand{\Pending}{\ensuremath{\c{Pending}}}
\newcommand{\PendingLs}{\ensuremath{\c{Pending}(ls)}}
\newcommand{\Undefined}{\ensuremath{\c{Undefined}}}

\newcommand{\Validate}{\ensuremath{\c{Validate}}}
\newcommand{\Checked}[2]{\ensuremath{\c{Checked}(#1,#2)}}
\newcommand{\WaitFor}[1]{\ensuremath{\c{WaitFor}(#1)}}
\newcommand{\status}[2]{\ensuremath{#1(#2)}}
\newcommand{\msgSent}[3]{\ensuremath{#1,#2\rightsquigarrow{}#3}}
\newcommand{\checkLocal}[2]{\ensuremath{\c{checkLocal}(#1,#2)}}
\newcommand{\checkLocalOpen}[2]{\ensuremath{\c{checkLocalOpen}(#1,#2)}}

\newcommand{\checkNeighs}[3]{\ensuremath{\c{checkNeighs}(#1,#2,#3)}}
\newcommand{\fracEmpty}[2]{\genfrac{}{}{0pt}{0}{#1}{#2}}
\newcommand{\vProg}{\c{vProg}}
\newcommand{\tripleConstraints}[1]{\c{tripleConstraints(#1)}}
\newcommand{\rbe}[1]{\ensuremath{\c{rbe}(#1)}}
\newcommand{\combine}[2]{\ensuremath{\c{combine}(#1,#2)}}