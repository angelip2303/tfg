...
\label{chapter:first}
\input{thesis_07_first-sol}

\chapter{Second Pregel solution}
\label{chapter:second}
\input{thesis_08_second-sol}

\chapter{Experimental Procedure}
\label{chapter:experiment}
\input{thesis_09_experiment}

\part{Project Synthesis}

\chapter{Results and Analysis}
\label{chapter:results}
\input{thesis_10_results}

\chapter{Planning and Budget}
\label{chapter:planning}
\input{thesis_11_planning}

\chapter{Conclusions}
\label{chapter:conclusions}
\input{thesis_12_conclusions}
