...
\chapterimage{img/heading_main.pdf} % Chapter heading image
...
\input{thesis_10_planning}

\chapter{Conclusions}
\label{chapter:conclusions}
\input{thesis_11_conclusions}

\part{Annexes and References}

\chapterimage{img/heading_bib.jpg} % Chapter heading image
