...
% package to properly describe the terms used, we put it after hyperref for the links to be clickable
\usepackage[nonumberlist]{glossaries} 

% package for fancy style headers and footersz
\usepackage{fancybox}
...
% write the entries of the glossary

\newglossaryentry{dumps}
{
    name=dump,
