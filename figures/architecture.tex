...
\begin{tikzpicture}[
    ...
    \node[worker,label={[yshift=-4.6cm, font=\sffamily]Worker1}] (worker1) {};
    \node[worker,label={[yshift=-4.6cm, font=\sffamily]Worker2}] (worker2) [right=0.5cm of worker1] {};
    \node[worker,label={[yshift=-4.6cm, font=\sffamily]Worker3}] (worker3) [right=0.5cm of worker2] {};
