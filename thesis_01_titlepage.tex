\begin{titlepage}
    ...
    Analysis and implementation of an algorithm to validate Knowledge Graphs using Big data techniques}\\[2\baselineskip] % Title
    ...
    {\noindent University of Oviedo 2023}\\[\baselineskip] % Publisher and logo
    }}
    %
    %
\end{titlepage}