...
\begin{example}
    fragment of the information about Alan Turing that models one of his employers is represented as follows\footnote{\url{https://www.wikidata.org/wiki/Special:EntityData/Q7251.ttl}}
\end{example}
