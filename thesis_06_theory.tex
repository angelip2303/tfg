...
The figure \ref{fig:wikibase:graph} shows a visualization of the previously described \ref{tab:wikibase:graph} Wikibase graph. Notice that in table \ref{tab:wikibase:graph} a human-readable version of the wikibase graph is provided, each of the elements shown are language-agnostic URIs.
